document.addEventListener("DOMContentLoaded", async function () {
  ...
  function showProductData(productData, productCommentsData) {
    ...
    // Verificar si los elementos existen antes de intentar crear los elementos
    if (productNameElement && productDescriptionElement && productPriceElement && productImageElement && productCommentsDiv) {
      ...
      if (Array.isArray(productData.images)) {
        for (const imageUrl of productData.images) {
          ...
          productImageItem.classList.add("product-image"); // Agrega una clase para estilos CSS
